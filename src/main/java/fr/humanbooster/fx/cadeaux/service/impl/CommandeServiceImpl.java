...
public class CommandeServiceImpl implements CommandeService {
	...
	@Override
	public Commande recupererCommandeUtilisateurParId(Utilisateur utilisateur, Long id) {
	...
	@Override
	public Commande recupererCommandeArticleParId(Article article, Long id) {
		Commande maCommande = null;
